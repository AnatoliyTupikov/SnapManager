...
namespace SnapManager.Models.WPFModels.CredentialHierarchy
{
    ...
    public class CredentialWpfModel : TreeItemWpfModel
    {
        public CredentialDModel? CastedDModel
        {
            get
            {
                var res = DModel as CredentialDModel;
        ...
        {
            get { return username; }
            set { OnPropertyChanged(ref username, value); ValidateProperty(value, nameof(Username)); }
        }
        ...
        {
            get { return password; }
            set { OnPropertyChanged(ref password, value); ValidateProperty(value, nameof(Password)); }
        }
